 ...
 * @assignment  BunnyHop
 * @brief       Holds all the game assets textures
 *
 * @notes       
 */
...
public class Assets implements Disposable, AssetErrorListener {
    ...
    public class AssetPortal{
    	...
    	public AssetPortal(TextureAtlas atlas){
