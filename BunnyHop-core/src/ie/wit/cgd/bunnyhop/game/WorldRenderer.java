 ...
 * @assignment  BunnyHop
 * @brief       Renders all the visuals of the game
 *
 * @notes       
 */
...
public class WorldRenderer implements Disposable{
	...
	private void renderGui(SpriteBatch batch) {
        ...
        // draws Game Over when you lose all your lives
        renderGuiGameOverMessage(batch);
        
        //draws the feather powerup icon and timer countdown
	...
	private void renderGuiExtraLive(SpriteBatch batch) {
        float x = cameraGUI.viewportWidth - 50 - worldController.lives * 50;
        float y = -15;
