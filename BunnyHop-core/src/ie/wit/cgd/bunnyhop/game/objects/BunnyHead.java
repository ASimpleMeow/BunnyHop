 ...
 * @assignment  BunnyHop
 * @brief       The player character asset
 *
 * @notes       
 */
...
public class BunnyHead extends AbstractGameObject{
    ...
    public float			timeLeftInvincibility;
    ...
    public void init() {
        ...
        timeLeftInvincibility = Constants.INVINCIBLITY_TIME;
        canTakeDamage = true;								  //Bunny Head can receive damage
    }
    ...
    public void update(float deltaTime) {
        ...
        if(!canTakeDamage){
        	timeLeftInvincibility -= deltaTime;
        	if(timeLeftInvincibility < 0){
        		timeLeftInvincibility = Constants.INVINCIBLITY_TIME;
        		canTakeDamage = true;
        	}
        }
    ...
    public void render(SpriteBatch batch) {
        ...
        if (!canTakeDamage) {
            if (((int) (timeLeftInvincibility * 7) % 2) != 0) {
